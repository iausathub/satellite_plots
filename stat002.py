...
ax.fill_between(year,0,-debris,label='Tracked Debris')
ax.fill_between(year,leftovers,0,label='Leftovers')
ax.fill_between(year,leftovers+dead+active,leftovers+dead,label='Active')
ax.fill_between(year,leftovers+dead,leftovers,label='Dead')
ax.fill_between(year,leftovers+dead+active+starlink,leftovers+dead+active,label='Starlink')
plt.xlim(1957,2025)
# plt.ylim(0,20000)
